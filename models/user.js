...
module.exports.getUserByUsername = function(username, callback){
	var query = {$or: [{username: username}, {email: username}],$and: [{role: 'user'}] };
	Userlist.findOne(query, callback);
}
module.exports.getAdminByUsername = function(username, callback){
	var query = {$or: [{username: username}, {email: username}],$and: [{role: 'admin'}] };
	Userlist.findOne(query, callback);
}
module.exports.getSellerByUsername = function(username, callback){
	var query = {$or: [{username: username}, {email: username}],$and: [{role: 'seller'}] };
	Userlist.findOne(query, callback);
}
